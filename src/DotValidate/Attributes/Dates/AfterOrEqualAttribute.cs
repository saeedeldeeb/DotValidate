...
/// <summary>
/// Specifies that a date property value must be after or equal to the specified date.
/// Supports keywords: "now", "today", "utcnow", or any valid date string.
/// </summary>
public sealed class AfterOrEqualAttribute : ValidationAttribute
{
    /// <summary>
    ...
    protected override string DefaultErrorMessage => "{0} must be after or equal to {1}.";
    ...
    public AfterOrEqualAttribute(string date)
    {
