...
/// <summary>
/// Specifies that a date property value must be before the specified date.
/// Supports keywords: "now", "today", "utcnow", or any valid date string.
/// </summary>
public sealed class BeforeAttribute : ValidationAttribute
{
    /// <summary>
    ...
    protected override string DefaultErrorMessage => "{0} must be before {1}.";
    ...
    public BeforeAttribute(string date)
    {
