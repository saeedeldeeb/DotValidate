...
/// <summary>
/// Specifies that a date property value must be after the specified date.
...
public sealed class AfterAttribute : ValidationAttribute
{
    ...
    protected override string DefaultErrorMessage => "{0} must be after {1}.";
    ...
    public AfterAttribute(string date)
    {
