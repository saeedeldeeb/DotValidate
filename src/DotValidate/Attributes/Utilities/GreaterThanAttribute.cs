...
/// <summary>
/// Specifies that a property must be greater than another property.
/// Works with any type that implements IComparable (numbers, dates, etc.).
/// </summary>
public sealed class GreaterThanAttribute : ConditionalValidationAttribute
{
    protected override string DefaultErrorMessage => "{0} must be greater than {1}.";

    /// <summary>
    /// Initializes a new instance specifying the property to compare against.
    /// </summary>
    /// <param name="otherProperty">The name of the property that this value must be greater than.</param>
